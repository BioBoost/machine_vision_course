...
![Voorgrond en achtergrond](img/foreground_background.png)
...
![Wit licht (links) en infrarood licht (rechts) - beiden monochrome camera](img/nir_crayon_example.png)
...
![Dome light principe](img/dome_light_principle.png)
